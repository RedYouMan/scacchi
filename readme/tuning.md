...
Con il programma scacchi-it è possibile fare un minimo di tuning tra Windows e chess engine. Questa attività riguarda solo se attivate l'engine con CntrlZ per giocarvi contro,
...
Il programma scacchi-it una volta letto i valori da chessparam.cnf, se essi sono maggiori di 0, li passa con comandi uci standard al chess engine.
...
Ovviamente il secondo valore è 12 Mbyte, ovvero ho dato 3 Mbyte a threads.
